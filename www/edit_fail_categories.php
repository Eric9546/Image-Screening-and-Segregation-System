...
<html lang="en">
  <head>
    <title>Edit Fail Categories</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Remove Fail Category</h2>
          </div>
          <div class="col-md-7">

            <form action="remove_fail_category.php" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="Remove Fail Category">
                  </div>
                </div>
              </div>
            </form>
          ...
          <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Add Fail Category</h2>
          </div>
          <div class="col-md-7">

            <form action="add_fail_category.php" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="text" class="text-black">Fail Category <span class="text-danger">*</span></label>
                    <br />
                    <input type="text" class="form-control" id="fail_category" name="fail_category" placeholder="Fail Category" required>
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="Add Fail Category">
                  </div>
                </div>
              </div>
            </form>
