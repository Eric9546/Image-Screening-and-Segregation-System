...
<html lang="en">
  <head>
    <title>View Passed Images</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center mb-5 col-12">
            <h2 class="text-uppercase">Images That Have Passed Inspection</h2>
              <br />
               <h4>
        ...
        <div class="row">           
            ...
            <?php 
                ...
                for ($i=2; $i<$total; $i++)
                {
                    ...
                    echo '<a href="passed_images/' . $results_array[$i] . '" class="product-item md-height bg-gray d-block" target="_blank">';
                    echo '<img src="passed_images/' . $results_array[$i] . '" alt="Image" class="img-fluid">';
                    echo '</a>';
                    echo '<h5 class="item-price"><a href="passed_images/' . $results_array[$i] . '" target="_blank">'. $results_array[$i] . str_repeat('&nbsp;', 5) . '</a>';
                    echo '<a href="passed_images/' . $results_array[$i] . '" download><span class="icon-download display-4 text-black"></span></a>';
                    echo '</h5>';
                    echo '</div>';
